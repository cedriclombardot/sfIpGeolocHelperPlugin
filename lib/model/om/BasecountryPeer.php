  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in sfGuardUserPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related sfGuardUser objects
			$c = new Criteria(sfGuardUserPeer::DATABASE_NAME);
			
			$c->add(sfGuardUserPeer::PAYS_ID, $obj->getIso());
			$affectedRows += sfGuardUserPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
